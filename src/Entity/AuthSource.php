 ...
 *     "edit-form" = "/admin/config/people/saml/authsource/{auths_ource}/edit",
 *     "delete-form" = "/admin/config/people/saml/authsource/{auth_source}/delete",
 *   }
 * )
 */
